...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::monitor::analyze_memory,
            commands::monitor::list_clients,
            commands::monitor::kill_client,
            commands::monitor::get_command_stats,
            commands::monitor::get_latency,
